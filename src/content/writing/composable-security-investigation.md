...
description: "As I've been building the first generation of agentic security tools for my SecOps team, one question has bubbled to the top: How do we get \"the robot\" to do the right thing?"
date: 2026-01-01
maturity: evergreen
tags: ["security", "playbooks", "automation", "agentic", "secops"]
draft: false
aliases: ["/posts/2026-01-01_Composable-security-investigations"]
---
...
- [Example playbook: Find the geolocation of an external IP address](/playbooks/geoip-lookup/)
